...
https://datawrapper.dwcdn.net/EyuhI/1/
...
md_gov_county <- md_gov_county |>
  mutate(
    total_votes = Moore + Cox + Lashar + Wallace + Harding,
...
Instead of the whole country, the map only showed Maryland with counties organzied by color. 
...
When you hover over an area, instead of it saying the fips code it says the county and the number now shows up as a percentage.
...
https://datawrapper.dwcdn.net/zlVHK/1/
