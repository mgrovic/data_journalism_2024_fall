...
The columns are missing titles that are helpful. 
...
Most of the Data is made up of NA
```{r}
...
The columns and header additions make the data more managable, however the data is still majority N/A
```{r}
benzie_2024 <- benzie_2024 |>
