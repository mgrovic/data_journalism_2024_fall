...
```{r echo=FALSE}
census_api_key("03183f1d7157fca8529a26898cff8c1b802565ed", install=TRUE)
```
...
Nevada is the state with the biggest change. 
```{r}
...
Yes, it seems that Montgomery County's margin of error is about half of Calvert's

Is the difference between Howard and everyone else significant? **Answer**
No I don't think it is. It is quite similar to the majority of the others. Counties like Kent or Queen Anne's may be statistically significantly larger. 
...
**Answer**
No Counties had their median incomes fall from 2010 to 2022, and non are outside the margin of error. 
```{r}
md10 |>
...
**Answer**
One of the top 20 zip codes (21202), had an estimated median household income of less than 50,000. 
```{r}
...
How do housing costs in these ZIP codes compare to other areas? 
Is there a significant income disparity within these ZIP codes?